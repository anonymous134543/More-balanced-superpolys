...
const int THREAD = 64;
const int MAX = 50000; // the maximum value of PoolSearchMode, P625
...
STATUS MidSolutionCounter(int start, int end, bitset<80> &cube ,const bitset<288>& startcube, const
    bitset<288>& laststate, vector<bitset<288>> & sols, float
    time, int thread, bool outputFlag)
{
    ...
    bitset<288> varsFlag;
    setRoundFlags(start, cube, nonZeroFlag, varsFlag, nonZeroTrackReps, varsTrackReps);
