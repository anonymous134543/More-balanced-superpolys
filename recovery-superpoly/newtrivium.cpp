...
STATUS newForwardExpandPolynomial(int start,int end, bitset<80>& cube, bitset<288> & startstate,map<bitset<288>,int,CMPS<288>> & counterMap, float time, int threads)
{
